export const navLinks = [
  ...
  { label: 'Patient Records', href: '#work' },
...
export const aboutStats = [
  { label: 'Software', value: 'Adobe CC' },
  { label: 'Software', value: 'Meta Business Suite' },
  { label: 'Software', value: 'Unreal Engine' },
  { label: 'Software', value: 'Blender' },
  { label: 'Software', value: '3D Visualizations' },
];

export const experienceItems = [
  {
    period: '2024 - Current',
    role: 'Chief Designer / Multimedia',
